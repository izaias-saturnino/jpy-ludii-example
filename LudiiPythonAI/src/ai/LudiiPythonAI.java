...
public class LudiiPythonAI extends AI
{
	...
	/** Did we perform initialization required for JPY? */
	...
	public void initAI(final Game game, final int playerID)
	{
		...
		if (!initialisedJpy)
		{
			...
			if (!PyLib.isPythonRunning()) 
			{
				...
				PyLib.startPython("/home/izaias/Documents/GitHub/LudiiPythonAI/");
			}
			
			ludiiPythonModule = PyModule.importModule("ludii_python.uct_root_reuse");
			initialisedJpy = true;
		}		
