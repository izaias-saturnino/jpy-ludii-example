...
modified by Izaias Saturnino de Lima Neto
"""
    ...
    def select_action(self,
        ...
        if self.root == None:
            ...
            for i in range(num_children):
                ...
                if child.context.state() == context.state():
                    root = child
                    child_found = True
                    break
            if not child_found:
        ...
        best_child = self.final_move_selection(root)
        self.last_move = best_child.move_from_parent
